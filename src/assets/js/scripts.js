...
export const cafeteria = [
    ...
    // *--------------------------- 
    "Menú del 22 al 19 26 agosto",
    "Menu from august 22 to 26",
    "August 19,2022"
];
...
export let equipos = {
    ...
    secun: {
        ...
        eq: [
            ...
            {"nombre":"Mrs. Marielos de Walsh", "cargo":"ARTE","position":"ART","link":"/assets/img/equipo/secundaria/09_Marielos_de_Walsh.jpg"}
        ]
    },
    nivel: {
